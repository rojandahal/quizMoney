...
/**
 * This class will get question from the given url as a JSON file which will be passed into the
 * quiz game activity
 */
public class QuestionBank {
    ...
    public void getQuestions(){
        new AsyncGetQuestions(url).execute();
    }


    /**
     * This is a class which will run in background to get the list of the questions from the url
     * and it will post the list to the list created in the LoginDetailsAPI class to set access for the game
     */
    public static class AsyncGetQuestions extends AsyncTask<Void,Void,Void> {
        ...
        public AsyncGetQuestions(String url) {
            this.url = url;
        }

        /** This method will get question from the JsonRequest and save all of them as a list in the
         * list made in LoginDetailsAPI class which will be accessible by the whole application
         * */
        @Override
